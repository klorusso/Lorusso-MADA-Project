...
## General Background Information
 This dataset contains information about immunization coverage rates in public and non-public schools in Conneticut. 

## Description of data and data source
This dataset is a part of the annual pre-kindergarten school immunization survey from the State of Conneticut. It was obtained from Data.Gov and was last updated on August 2, 2025. 

## Questions/Hypotheses to be addressed
Through this analysis project, I would like to examine the relationship between public and non-public schools and see if vaccination rates vary between the two. I would also like to look at each vaccine and analyze trends to see if the coverage rates vary. 

```{r}
PKIR <- read.csv("/Users/katherinelorusso/Desktop/2024-2025_Kindergarten_Immunization_Rates_by_School.csv")
